...
export function CurrentUserWordlessEmote({
    ...
    const [isDeleteEmoteDialogOpen, setIsDeleteEmoteDialogOpen] = useState(false);
    ...
    const emoteInfo = () => {
        ...
        if (isMobile) {
                            ...
                            <Row align="bottom" justify="space-between">
                                ...
                                <Col>
                                    <DeleteIconButton
                                        size="small"
                                        onClickAction={() => {
                                            setIsDeleteEmoteDialogOpen(true);
                                        }}
                                    />
                                </Col>
                            </Row>
            ...
            return (
                <div>
                    <Row align="bottom" justify="space-between" className={textBlockStyle}>
                        <Col>
                            <Row align="bottom">
                                <div className={userNameTextStyle} onClick={navigateToUserPage}>
                                    {emote.userName}
