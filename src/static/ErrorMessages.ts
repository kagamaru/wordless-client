export const errorMessages = {
    ...
    "USB-01": "不正なリクエストです。もう一度やり直してください。",
    "USB-02": "ユーザーが見つかりません。もう一度ログインしてください。",
    "USB-03": "エラーが発生しています。しばらくの間使用できない可能性があります。",
    "USB-04": "ユーザーが見つかりません。もう一度ログインしてください。",
    "USB-05": "エラーが発生しています。しばらくの間使用できない可能性があります。",
